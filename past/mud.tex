...
\begin{columns}
    \begin{column}{0.7\textwidth}
        \vspace{-2em}
        \input{past/figures/mode2_crack_path}
    \end{column}
    \begin{column}{0.3\textwidth}
...
\begin{columns}
    \begin{column}{0.7\textwidth}
        ...
        \input{past/figures/compare_correlation_length}
    \end{column}
    \begin{column}{0.3\textwidth}
        \vspace{-2em}
        \input{past/figures/statistics_correlation_length}
    \end{column}
\end{columns}
\end{frame}
...
\begin{columns}
    \begin{column}{0.7\textwidth}
        ...
        \input{past/figures/compare_morphology}
    \end{column}
    \begin{column}{0.3\textwidth}
        \vspace{-2em}
        \input{past/figures/statistics_morphology}
    \end{column}
\end{columns}
\end{frame}
...
\begin{columns}
    \begin{column}{0.5\textwidth}
        ...
        \input{past/figures/japanese_experiment}
    \end{column}
    \begin{column}{0.5\textwidth}
        \input{past/figures/mining_waste}
    \end{column}
\end{columns}
\end{frame}
