...
\begin{figure}[!htb]
    \begin{tikzpicture}[scale=0.8]
        ...
        \node[text width=\textwidth,anchor=north west,fill=white,opacity=.6,text opacity=1] at (-1.5, 1.0) {Wrap-up. Review (or even reformulate) previous modeling choices if necessary given previously obtained results.};
